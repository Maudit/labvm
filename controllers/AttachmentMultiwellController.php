...
use app\models\AttachmentMultiwell;
...
class AttachmentMultiwellController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    public function actionCreate($experiment_id)
    {
        ...
        if ($this->request->isPost && $model->load($this->request->post())) {
            ...
            if ($model->file) {
                ...
                $model->file_name = "$model->experiment_id-multiwell";
    ...
    {
        if (($model = AttachmentMultiwell::findOne(['experiment_id' => $experiment_id])) !== null) {
            return $model;
        }
