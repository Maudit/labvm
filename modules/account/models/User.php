...
{
    /** Un utente che non è abilitato ad usare il programma.  */
    const STATUS_DISABLED = 0;
    /** Un utente abilitato ad usare il programma. */
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'surname', 'username', 'email'], 'string', 'max' => 255],
            [['username'], 'unique'],
            [['email'], 'unique'],
            [['status'], 'integer'],
    ...
    public static function findByPasswordResetToken($token)
    {
        ...
        return static::findOne(['password_reset_token' => $token, 'status' => self::STATUS_ENABLED]);
    }
    ...
    {
        throw new NotSupportedException('"findByVerificationToken" is not implemented.');
