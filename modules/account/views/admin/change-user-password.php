...
/** @var app\modules\account\models\User $userModel */
...
$this->params['breadcrumbs'][] = ['label' => $userModel->getFullName(), 'url' => ['view-user','id'=>$userModel->id]];
...
<div class="row">
    <div class="col-lg-8 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="card-header">Cambia la password di <?= Html::encode($userModel->getFullName()) ?></div>
            <div class="card-body">
                <div class="row">
