...
/**
 * This is the model class for table "attachment_multiwell".
 *
 ...
 */
class AttachmentMultiwell extends \yii\db\ActiveRecord
{
    ...
    {
        try {
            $base_path = Yii::getAlias('@app/uploads/attachment-multiwell/' . $this->file_main_directory . '/' . $this->file_sub_directory);
     ...
     * ma una composizione indicante il tipo di file (M)ultiwell e gli 
    ...
    {
        return Yii::getAlias('@app/uploads/attachment-multiwell/' . $this->file_main_directory . '/' . $this->file_sub_directory);
    }
