...
/**
 * This is the model class for table "attachment_result".
 *
 ...
 */
class AttachmentResult extends \yii\db\ActiveRecord
{
    ...
    {
        try {
            $base_path = Yii::getAlias('@app/uploads/attachment-result/' . $this->file_main_directory . '/' . $this->file_sub_directory);
     ...
     * ma una composizione indicante il tipo di file (R)esult e gli 
    ...
    {
        return Yii::getAlias('@app/uploads/attachment-result/' . $this->file_main_directory . '/' . $this->file_sub_directory);
    }
